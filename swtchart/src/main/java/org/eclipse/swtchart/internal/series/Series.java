...
abstract public class Series<T> implements ISeries<T>
{
   ...
   /**
    * @see org.eclipse.swtchart.ISeries#setDataModel(org.eclipse.swtchart.model.CartesianSeriesModel)
    */
   @Override
   ...
   /**
    * @see org.eclipse.swtchart.ISeries#enableStack(boolean)
    */
   @Override
   ...
   /**
    * @see org.eclipse.swtchart.ISeries#setXSeries(double[])
    */
   ...
   /**
    * @see org.eclipse.swtchart.ISeries#getYSeries()
    */
   @Override
